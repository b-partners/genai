...
import fr.birdia.genai.conf.FacadeIT;
import fr.birdia.genai.endpoint.event.consumer.model.ConsumableEvent;
import fr.birdia.genai.endpoint.event.consumer.model.ConsumableEventTyper;
import fr.birdia.genai.endpoint.event.consumer.model.TypedEvent;
import fr.birdia.genai.endpoint.event.model.UuidCreated;
