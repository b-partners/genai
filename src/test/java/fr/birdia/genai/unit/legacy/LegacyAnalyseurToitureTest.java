package fr.birdia.genai.unit.legacy;
...
class LegacyAnalyseurToitureTest {

  private final Chat chat = mock(Chat.class);
  private final LegacyAnalyseurToiture subject =
      new LegacyAnalyseurToiture(chat, new PromptEngine());

  private LegacyToit toit(String commentaireCouvreur) {
    return new LegacyToit(
        "1 rue de la Toiture",
        "0,0",
        2018,
        2024,
