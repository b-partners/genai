package school.hei.hazavao.unit;
...
import school.hei.hazavao.endpoint.event.consumer.model.ConsumableEvent;
import school.hei.hazavao.endpoint.event.consumer.model.ConsumableEventTyper;
import school.hei.hazavao.endpoint.event.consumer.model.TypedEvent;
import school.hei.hazavao.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("school.hei.hazavao.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("school.hei.hazavao.endpoint.event.model.UuidCreated", payload);
