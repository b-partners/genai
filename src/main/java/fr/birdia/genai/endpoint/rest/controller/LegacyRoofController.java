 ...
 * have not migrated to the new BIRDIA état apparent contract served by {@link RoofController}. Also
 * serves the root {@code /} path for callers still hitting it directly.
 */
@RestController
@AllArgsConstructor
